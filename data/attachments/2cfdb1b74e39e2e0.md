...
Call log:
  ...
  - waiting for locator('.MuiDataGrid-row').first().locator('.MuiDataGrid-cell[data-field="createdAt"]')
    33 × locator resolved to <div tabindex="-1" role="gridcell" aria-colspan="1" data-colindex="1" aria-colindex="2" title="04/04/2026" data-field="createdAt" class="MuiDataGrid-cell MuiDataGrid-cell--textLeft">04/04/2026</div>
