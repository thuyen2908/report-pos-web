...
Call log:
  ...
  - waiting for locator('.MuiDataGrid-row').first().locator('.MuiDataGrid-cell[data-field="giftCardLogType"]')
    34 × locator resolved to <div tabindex="-1" role="gridcell" aria-colspan="1" data-colindex="4" aria-colindex="5" title="ActivateAddOn" data-field="giftCardLogType" class="MuiDataGrid-cell MuiDataGrid-cell--textLeft">ActivateAddOn</div>
